...
config.addon = {
  ...
  set timezoneSpoof (val) {app.storage.write("timezoneSpoof", val)},
  set timezone (val) {app.storage.write("timezone", val)},
  ...
  get timezoneSpoof () {return app.storage.read("timezoneSpoof") !== undefined ? app.storage.read("timezoneSpoof") : false},
  get timezone () {return app.storage.read("timezone") !== undefined ? app.storage.read("timezone") : "auto"}
};
